...
class AlienInvasion:
	...
	def _check_bullet_alien_collisions(self):
		"""Check for any bullets that have hit aliens and delete them."""
	...
	def start_new_level(self):
		"""Check if the current fleet has been destroyed."""
		if not self.aliens:
